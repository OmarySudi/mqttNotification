...
//        notificationRepository.save(newNotification);
        System.out.println("Before sending............");
        // mqttNotification.sendNotification(newNotification);
        pubNubNotification.customerCancellTrip(newNotification);
        System.out.println("Notification sent............");
...
//        notificationRepository.save(newNotification);
    ...
    @PostMapping(value = "/driver-start-trip")
    public ResponseEntity<CustomResponse<Notification>> driverStartTrip(@RequestBody Notification notification){
...
//        notificationRepository.save(newNotification);
        System.out.println("Before sending............");
        // mqttNotification.sendNotification(newNotification);
        pubNubNotification.driverStartTrip(newNotification);
        System.out.println("Notification sent............");
    ...
    @PostMapping(value = "/driver-end-trip")
    public ResponseEntity<CustomResponse<Notification>> driverEndTrip(@RequestBody Notification notification){
...
//        notificationRepository.save(newNotification);
        //System.out.println("Before sending............");
        // mqttNotification.sendNotification(newNotification);
        pubNubNotification.driverEndTrip(newNotification);
        //System.out.println("Notification sent............");
